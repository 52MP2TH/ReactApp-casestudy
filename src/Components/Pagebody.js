...
class Pagebody extends Component {
    constructor() {
        ...
        this.sendUserIdtoProductspage = this.sendUserIdtoProductspage.bind(this)
    }
    ...
    sendUserIdtoProductspage() {
        const userId = this.props.userId;
        this.props.history.push("/Products/:" + userId)
    }
        ...
        return (
            <div>
                <div id="mySidebar" className="sidebar">
                    ...
                    <Link to="#" onClick={this.sendUserIdtoProductspage}>Products</Link>
                </div>
